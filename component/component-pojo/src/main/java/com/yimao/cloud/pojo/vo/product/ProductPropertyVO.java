...
public class ProductPropertyVO {
    ...
    @ApiModelProperty(position = 2, value = "产品类型 1、实物商品 2、电子卡券  3、 租赁商品")
    private Integer typeId;             //产品类型 1、实物商品 2、电子卡券  3、 租赁商品
    ...
    @ApiModelProperty(position = 10, value = "产品属性值的列表")
    private List<ProductPropertyValueDTO> propertyValues;
}