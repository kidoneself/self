...
public class VerificationCodeImgUtil {
    ...
    public static final String STATION_LOGIN_CODE = "STATION_LOGIN_CODE";
     ...
     * @return
     */
    public static VerificationCodeImgUtil getStationLoginCodeImg() {
        return new VerificationCodeImgUtil(160, 40, 5, 150);
    }
