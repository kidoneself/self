...
public interface SystemFeign {
    ...
    Object getNewAppVersion(@RequestParam("version") String version, @RequestParam("systemType") Integer systemType, @RequestParam("appType") Integer appType);

    @GetMapping(value = "/ios/getUrl")
    AppUrlDTO getIOSUrl(@RequestParam("version") Integer version);
