...
public class MenuController {
    ...
    public void save(@RequestBody MenuDTO dto) {
        userFeign.saveMenu(SystemType.SYSTEM.value, dto);
    }
    ...
    public PageVO<MenuDTO> page(@PathVariable Integer pageNum,
        ...
        return userFeign.getMenuPageByParams(pageNum, pageSize, SystemType.SYSTEM.value, id);
    }
    ...
    public List<MenuDTO> listMenuTree() {
        return userFeign.listMenuTree(SystemType.SYSTEM.value);
    }
