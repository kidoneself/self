...
public interface AdminMapper extends Mapper<Admin> {
     ...
     */
    Page<AdminDTO> selectWithRole(@Param("sysType") Integer sysType, @Param("roleId") Integer roleId, @Param("deptId") Integer deptId,
                                  @Param("realName") String realName, @Param("forbidden") Boolean forbidden);
