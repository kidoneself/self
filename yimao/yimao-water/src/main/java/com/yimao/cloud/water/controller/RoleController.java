...
public class RoleController {
    ...
    public void save(@RequestBody RoleDTO dto) {
        userFeign.saveRole(SystemType.WATER.value, dto);
    }
    ...
    public PageVO<RoleDTO> page(@PathVariable Integer pageNum,
        ...
        return userFeign.getRolePageByParams(pageNum, pageSize, SystemType.WATER.value);
    }
    ...
    public List<MenuDTO> listMenuAndPermission(@RequestParam(required = false) Integer roleId) {
        return userFeign.listMenuAndPermission(SystemType.WATER.value, roleId);
    }
