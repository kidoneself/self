...
public class AdminController {
    ...
    public void save(@RequestBody AdminDTO dto) {
        userFeign.saveAdmin(SystemType.WATER.value, dto);
    }
    ...
    @ApiImplicitParams({
            @ApiImplicitParam(name = "pageNum", value = "第几页", required = true, dataType = "Long", paramType = "path", defaultValue = "1"),
            @ApiImplicitParam(name = "pageSize", value = "每页大小", required = true, dataType = "Long", paramType = "path", defaultValue = "10"),
    ...
    public PageVO<AdminDTO> listAdmin(@PathVariable Integer pageNum,
        ...
        return userFeign.getAdminPageByParams(pageNum, pageSize, SystemType.WATER.value, roleId, deptId, realName, forbidden);
    }
