...
(function($) {
    ...
    Browser.prototype.tip = function(showCoontent) {
        ...
        if(!$browseHappy.length) {
            $browseHappy = $('<div id="browseHappyTip" class="alert alert-dismissable alert-danger-inverse alert-block" style="position: relative; z-index: 99999"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">脳</button><div class="container"><div class="content text-center"></div></div></div>');
        ...
        return function(url, ready, load, error) {
            ...
            onready = function() {
                ...
                if(newWidth !== width || newHeight !== height ||
                    // å¦‚æžœå›¾ç‰‡å·²ç»åœ¨å…¶ä»–åœ°æ–¹åŠ è½½å¯ä½¿ç”¨é¢ç§¯æ£€æµ‹
            ...
            img.onload = function() {
                ...
                // IE gifåŠ¨ç”»ä¼šå¾ªçŽ¯æ‰§è¡Œonloadï¼Œç½®ç©ºonloadå³å¯
                img = img.onload = img.onerror = null;
            };
            ...
            if(!onready.end) {
                list.push(onready);
                // æ— è®ºä½•æ—¶åªå…è®¸å‡ºçŽ°ä¸€ä¸ªå®šæ—¶å™¨ï¼Œå‡å°‘æµè§ˆå™¨æ€§èƒ½æŸè€—
