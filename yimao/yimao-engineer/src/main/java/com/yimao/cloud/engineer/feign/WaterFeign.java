...
public interface WaterFeign {
    ...
    /**
     * 创建维修工单-根据关键字及安装工服务区域选择水机设备列表
     * @param query
     * @return
     */
    @GetMapping(value = "/water/device/engineer/getWaterDeviceList",consumes = MediaType.APPLICATION_JSON_VALUE)
	List<WaterDeviceDTO> getWaterDeviceList(@RequestBody WaterDeviceQuery query);
    ...
    PageVO<WaterDeviceCompleteDTO> getCompleteWorkOrderList(@PathVariable(value = "pageNum") Integer pageNum,
                                                            @PathVariable(value = "pageSize") Integer pageSize,
    ...
    PageVO<WaterDevicePlaceChangeRecordVO> page(@PathVariable(value = "pageNum") Integer pageNum, @PathVariable(value = "pageSize") Integer pageSize, @RequestParam(value = "sn",required = false) String sn);
    ...
    PageVO<WaterDeviceCostChangeRecordDTO> getCostChangeRecordList(@PathVariable(value = "pageNum") Integer pageNum, @PathVariable(value = "pageSize") Integer pageSize, @RequestParam(value = "sn",required = false) String sn);
