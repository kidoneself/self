...
public interface UserFeign {
     ...
     * @param dto 用户信息
     */
    @RequestMapping(value = "/engineer/head", method = RequestMethod.PUT, consumes = MediaType.APPLICATION_JSON_VALUE)
    void updateHeadImg(@RequestBody EngineerDTO dto);

    @GetMapping(value = "/engineer/service/area/{id}")
    List<EngineerServiceAreaDTO> getEngineerServiceArea(@PathVariable(value = "id") Integer id);
}
