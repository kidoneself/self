package com.yimao.cloud.gateway.configuration;
...
public class GatewayConfiguration {
    ...
    private static final String ALLOWED_HEADERS = "x-requested-with,Authorization,authorization,Content-Type,content-type,credential,X-XSRF-TOKEN,token,client,ACCESS_TOKEN,USER_TOKEN,ADMIN_TOKEN,WATER_ADMIN_TOKEN,STATION_TOKEN,accessKey";
